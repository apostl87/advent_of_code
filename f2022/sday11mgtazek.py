...
def calc_monkey_business(rounds: int, part2: bool=False) -> int:
...
print(f'Part 1: {calc_monkey_business(rounds=20)}')
print(f'Part 2: {calc_monkey_business(rounds=10_000, part2=True)}')